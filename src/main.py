...
from bot.handlers.callback_groups import router as callback_router
from bot.handlers.users_dialog import select_users_dialog, select_users_for_group_dialog
...
async def main():
    ...
    dispatcher.include_routers(base_router, select_users_dialog, select_users_for_group_dialog,
                               callback_router)
